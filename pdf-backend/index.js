...
// Nueva versión con tamaño de letra y header dinámico
// app.post('/generate-pdf', async (req, res) => {
//   const { html, fontSize = 8, headerHtml } = req.body;
...
//       displayHeaderFooter: true,
//       headerTemplate: headerHtml || '<div></div>', // <-- aquí lo usas
//       footerTemplate: `
//         <div style="font-size:7px;text-align:center;width:100%">
