...
const productoUnidadVentaRoutes = require('./routes/productoUnidadVenta');
const formulaMatizadoRoutes = require('./routes/formulaMatizado');
...
app.use('/api', productoUnidadVentaRoutes);
app.use('/api', formulaMatizadoRoutes);
