...
api.get('/sucursalempresa/:idEmpresa', auth.auth, sucursalController.obtener_sucursal_por_empresa_destino);
api.put('/sucursal/:id/principal', auth.auth, sucursalController.establecer_sucursal_principal);
